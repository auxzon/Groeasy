  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: getInputBorder(border,  Color(0xFF949494)),
        enabledBorder: getInputBorder(enableborder, Color(0xFFC9C9C9)),
        focusedBorder: getInputBorder(focusborder, Color(0xFFCCCCCC)),
